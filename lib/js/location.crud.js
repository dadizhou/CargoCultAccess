...
function submitSavePOI(pageElements) {
    var data = {
        'title': pageElements.mapControls.mapForm.locationName.value,
        'description': pageElements.mapControls.mapForm.locationDescription.value,
        'latitude': pageElements.mapControls.mapForm.locationLatitude.value,
        'longitude': pageElements.mapControls.mapForm.locationLongitude.value
    };
...
function handlePOI(event, map, pageElements) {
    if (event.placeId) {
        ...
        placesService.getDetails({ placeId: event.placeId }, function (place, status) {
            if (status === 'OK') {
                pageElements.mapControls.mapForm.locationName.value = place.name;
                pageElements.mapControls.mapForm.locationDescription.value = place.formatted_address;
                pageElements.mapControls.mapForm.locationLatitude.value = place.geometry.location.lat();
                pageElements.mapControls.mapForm.locationLongitude.value = place.geometry.location.lng();
            }
        });
    } else {
